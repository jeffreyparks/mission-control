...
check("_format_salary: equal min/max -> single concise value", bi._format_salary((150000, 150000)) == "150k")
check("_format_salary: concise range", bi._format_salary((130000, 185000)) == "130k-185k")
check("_format_salary: non-round thousand keeps one decimal", bi._format_salary((162500, 187500)) == "162.5k-187.5k")
